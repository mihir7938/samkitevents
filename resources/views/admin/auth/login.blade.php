...
<head>
	...
	<link rel="stylesheet" href="{{asset('admin/css/core.min.css')}}">
...
<body>
	<div class="d-flex flex-column flex-md-row text-center text-md-start justify-content-between py-4 px-4 px-xl-5 bg-primary">		
		<div class="text-white mb-3 mb-md-0 header">
			<a href="{{route('index')}}" class="text-white">Samkit Events</a>
		</div>		
  	</div>
	  	...
	  	<div class="container-fluid h-custom">
			<div class="row d-flex justify-content-center align-items-center h-100">
		  		...
		  		<div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">       			  
					<form id="form-login" name="loginform" class="form-login" action="{{route('admin.authenticate')}}" method="POST">	  
			  			@csrf
